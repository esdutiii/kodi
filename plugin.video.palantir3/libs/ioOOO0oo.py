...
class Resolver ( object ) :
 ...
 def __new__ ( cls , enlace ) :
  if get_setting ( 'Alldebrid_enabled' ) and enlace . get ( 'servidor' ) in cls . getHosts ( 'Alldebrid' ) :
   ...
   if os . path . exists ( os . path . join ( xbmcvfs . translatePath ( 'special://profile/addon_data/plugin.video.palantir3/' ) , '1fichier.txt' ) ) :
    cls . subresolver = "fichier"
   else :
    xbmcgui . Dialog ( ) . ok ( 'Palantir 3' , localize ( 30506 ) )
    return
 ...
 def __init__ ( self , enlace ) :
  ...
  if self . url :
   ...
   self . dialog = P3DialogAnimation ( 'Palantir 3' , iIiIiiIIIiII )
...
class Alldebrid ( Resolver ) :
 ...
 "special://home/addons/plugin.video.palantir3/resources/media/alldebrid.png" )
    if 19 - 19: Ii
   return iIi111ii
 ...
 headers = { 'User-Agent' : self . AGENT } ) . data )
   ...
   if i1Ii1iiIiI111 . get ( "status" , "error" ) == 'success' :
    ...
    try :
     ...
     if Iii1I1I1 :
      logger ( Iii1I1I1 )
      xbmcgui . Dialog ( ) . notification ( "Palantir 3" , Iii1I1I1 ,
 "special://home/addons/plugin.video.palantir3/resources/media/alldebrid.png" )
    except : pass
...
class Realdebrid ( Resolver ) :
 ...
 'Realdebrid_client_id' ) :
  ...
  if Iii :
   xbmcgui . Dialog ( ) . notification ( 'Palantir 3' , Iii ,
 "special://home/addons/plugin.video.palantir3/resources/media/realdebrid.png" )
   if 81 - 81: Ii
  return iIi111ii
...
class fichier ( Resolver ) :
 def get_api ( self ) :
  ...
  oO00 = xbmcvfs . translatePath ( 'special://profile/addon_data/plugin.video.palantir3/1fichier.txt' )
