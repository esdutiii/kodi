# -*- coding: utf-8 -*-
__all__ = [ 'load_json_file' , 'Proxydatetime' , 'KODI_VERSION' , 'get_setting' , 'CACHE' , 'SetColor' , 'localize' , 'WINDOW' , 'compare_versions' , 'logger' , 'dump_json' , 'AES' , 'set_setting' , 'ISESTUARYPALANTIR' , 'load_json' , 'p3b64decode' , 'p3b64encode' , 'DialogImage' ]
if 82 - 82: Iii1i
import re
import os
import json
...
ISESTUARYPALANTIR = xbmc . getSkinDir ( ) == 'skin.estuary.palantir'
...
try :
 ...
 xbmcgui . Dialog ( ) . ok ( 'Palantir 3' , localize ( 30056 ) )
 exit ( )
...
class DialogImage ( xbmcgui . WindowXMLDialog ) :
 def __init__ ( self , heading , text ) :
  ...
  if oOo :
   ...
   oOo = "special://home/addons/plugin.video.palantir3/resources/media/icon.png"
 ...
 def __new__ ( cls , heading , text , image = None ) :
  return super ( DialogImage , cls ) . __new__ ( cls , "DialogImage.xml" , 'special://home/addons/plugin.video.palantir3' )
  if 41 - 41: O000o
 def onInit ( self ) :
