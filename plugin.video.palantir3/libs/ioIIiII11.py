...
from libs . iooooooOoO0 import logger , localize , Proxydatetime , set_setting , ISESTUARYPALANTIR , load_json , get_setting , CACHE , WINDOW
...
class Watched ( object ) :
 def __init__ ( self ) :
  ...
  if not os . path . exists ( xbmcvfs . translatePath ( 'special://profile/addon_data/plugin.video.palantir3/' ) ) :
   os . makedirs ( xbmcvfs . translatePath ( 'special://profile/addon_data/plugin.video.palantir3/' ) , exist_ok = True )
   if 58 - 58: I1Ii1I1 - ooOOO
  self . db_file = xbmcvfs . translatePath ( 'special://profile/addon_data/plugin.video.palantir3/watched.db' )
 ...
 def connect ( self ) :
  ...
  self . cursor . execute ( '''CREATE TABLE IF NOT EXISTS views 
                                (skin TEXT,
                                 content TEXT,
                                 view INTEGER NOT NULL DEFAULT 50,
 ...
 def _acquire_lock ( self ) :
  while WINDOW . getProperty ( "p3WatchedLock" ) == "true" :
 ...
 'plugin://plugin.video.palantir3/?' + P3Item ( nameWidget = "WidgetPelisFavoritas" ,
 ...
 'plugin://plugin.video.palantir3/?' + P3Item ( nameWidget = "WidgetSeriesFavoritas" ,
 ...
 def _activarTrakt ( self ) :
  if xbmcgui . Dialog ( ) . yesno ( 'Palantir 3' , localize ( 30507 ) ) :
   iIIIII1i111i = Trakt ( )
   if iIIIII1i111i . access_token :
    self . trakt = iIIIII1i111i
 ...
 'select label from listas_trakt where user="{0}" and list_id={1} and content="{2}"' . format ( O0o , o000OOO00 , iII11I11111I ) )
  ...
  IiO0 = [ 'Por título A-Z' , 'Por título Z-A' , 'Fecha de estreno, mas antigua primero' ,
 'Fecha de estreno, mas nueva primero' , 'Por valoración, de menor a mayor' ,
 'Por valoración, de mayor a menor' , 'Fecha de agregado, mas antigua primero' ,
 ...
 def addLiTrakt ( self ) :
  ...
  try :
   ...
   xbmcgui . Dialog ( ) . notification ( 'Palantir 3' ,
 localize ( 30516 ) ,
  ...
  if Proxydatetime . strptime ( O0OO , "%Y-%m-%dT%H:%M:%S.000Z" ) - Proxydatetime . strptime ( Ooo00OO000oo , "%Y-%m-%dT%H:%M:%S.000Z" ) > timedelta ( minutes = 2 ) :
   ...
   for oOOOOOOoOOooO0O0 in OOoOOo :
    ...
    if o000OOO00 in OOo0o00o :
     ...
     OoooOo00 = xbmcgui . Dialog ( ) . yesnocustom ( 'Palantir 3' , I11i , localize ( 30529 ) , localize ( 30101 ) ,
 localize ( 30100 ) )
     if OoooOo00 == 1 :
      iII11I11111I = 'movie'
     elif OoooOo00 == 0 :
...
class Trakt ( object ) :
 ...
 def authenticationDevices ( self ) :
  ...
  self . dialog . create ( 'Palantir 3' , "Trakt.tv" )
 ...
 def get_list ( self ) :
  ...
  OoooOo00 = xbmcgui . Dialog ( ) . yesnocustom ( 'Palantir 3' , I11i , localize ( 30515 ) , localize ( 30101 ) ,
 localize ( 30100 ) )
  if OoooOo00 == 1 :
   iII11I11111I = 'movie'
  elif OoooOo00 == 0 :
 ...
 def addRatings ( self , content , label , tmdb , seasonNumber = 1 , episodeNumber = 1 , forzado = False ) :
  ...
  if self . access_token and content in [ 'tvshows' , 'tvshow' , 'seasons' , 'episodes' , 'movies' , 'movie' ] :
   if content in [ 'tvshows' , 'tvshow' ] :
    oo0OOOOOO0o00 = "¿Que te pareció esta serie?"
   elif content == 'seasons' :
    oo0OOOOOO0o00 = "¿Que te pareció esta temporada?"
   elif content == 'episodes' :
    oo0OOOOOO0o00 = "¿Que te pareció este episodio?"
   else :
    oo0OOOOOO0o00 = "¿Que te pareció esta película?"
    if 74 - 74: i1 + oOO
...
class oO0ooOo0OOOO ( xbmcgui . WindowXMLDialog ) :
 ...
 def __new__ ( cls , content , title , label ) :
  return super ( oO0ooOo0OOOO , cls ) . __new__ ( cls , "RatingDialog.xml" , 'special://home/addons/plugin.video.palantir3' )
