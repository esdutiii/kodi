...
from libs . iooooooOoO0 import logger , localize , KODI_VERSION , set_setting , ISESTUARYeduteamo , load_json , get_setting , CACHE , SetColor , WINDOW
...
def menu ( p3Item ) :
 ...
 for ooOOooO0 , i1iiiiIIIiIi , II , OO0000 , oOoo0 in oOooo0OOO [ p3Item . page * 50 : 50 + p3Item . page * 50 ] :
  if ooOOooO0 in ('#30102', '#30103') or 'dibujos' in str(II).lower() or 'anime' in str(II).lower():
   continue
 ...
 sql = OO0000 )
  ...
  if II :
   if II . startswith ( "http" ) :
    ...
    o00 . icon = 'special://home/addons/plugin.video.eduteamo/resources/media/' + II
    if 70 - 70: IiIIii11Ii
  i1I1 . append ( o00 )
 ...
 sql = p3Item . sql )
  if ISESTUARYeduteamo :
   o00 . fanart = "special://home/addons/plugin.video.eduteamo/resources/media/fanartmas.png"
   o00 . poster = "special://home/addons/plugin.video.eduteamo/resources/media/mas.png"
   o00 . clearlogo = "special://home/addons/plugin.video.eduteamo/resources/media/clearlogomas.png"
  i1I1 . append ( o00 )
...
def listado_colecciones_series ( p3Item ) :
 ...
 sql = p3Item . sql )
  ...
  xbmcgui . Dialog ( ) . ok ( 'EduTeAmo' , iI1iI )
...
def listado_random ( p3Item ) :
 ...
 with open ( xbmcvfs . translatePath ( 'special://profile/addon_data/skin.estuary.eduteamo/settings.xml' ) , 'r' , encoding = 'utf-8' ) as ii1iIii :
  o0o = ii1iIii . read ( )
  if 17 - 17: IiIIii11Ii
 for Ooo0OO , Iio0O0 , iII11iI1i in re . findall ( r'"hidespotlight(.*?)_(.*?)" type="bool">([^<]+)<' , o0o ) :
  if iII11iI1i == 'false' :
   Iio0O0 = Iio0O0 . capitalize ( ) . replace ( 'Pelicula' , 'PelÃ­cula' ) . replace ( 'Musica' , 'MÃºsica' )
   if Ooo0OO == 'pelis' :
...
def listado_peliculaS ( p3Item ) :
 ...
 action = "selectvideos_"
    ...
    if O0Ooo0oOo0 == 'PelÃ­cula' :
     o00 . sub_categoria = 'pelis_Pelicula'
    elif O0Ooo0oOo0 == 'MÃºsica' :
...
def listado_temporadaS ( p3Item ) :
 ...
 if len ( i1I1 ) == 1 and i1I1 [ 0 ] . season == 1 and not ISESTUARYeduteamo :
...
def selectvideos_ ( p3Item , lista_enlaces_previa = None ) :
 ...
 type = xbmcgui . INPUT_PASSWORD ) :
   ...
   xbmcgui . Dialog ( ) . ok ( 'EduTeAmo' , localize ( 30519 ) )
   return False
  else :
...
def play_nextEpisode ( p3Item , timedown , episodioSiguiente = None ) :
 ...
 if oOooo0OOO :
  ...
  OOO = xbmcgui . Dialog ( )
  OOO . ok ( 'EduTeAmo' , localize ( 30503 ) % (
...
def p3Play ( p3Item , enlace ) :
 ...
 if len ( OOoO0oOoOo ) > 1 :
  ...
  if 'api.alldebrid.com/v4' in OOoO0oOoOo . url :
   oOOOooo0O = load_json ( downloadpage ( OOoO0oOoOo . url , headers = { 'User-Agent' : 'EduTeAmo' } ) . data )
 ...
 if OOoO0oOoOo and OOoO0oOoOo . url :
  ...
  if OOoO0oOoOo . is_InputStream :
   try :
    ...
    OOO . ok ( 'EduTeAmo' , localize ( 30037 ) )
    return True
