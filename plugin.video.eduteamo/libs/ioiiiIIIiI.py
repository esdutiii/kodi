...
class Tmdb ( object ) :
 ...
 def request ( self , actions , id , params = None ) :
  ...
  IIiiii1IiIiII = self . _session . get ( OO0o000o ) . json ( )
 ...
 def getVideos ( self , tmdb , type ) :
  ...
  for O0o0O0o0o in OoOOoO000O . keys ( ) :
   ...
   Oo0 = self . _session . get ( OO0o000o )
   if Oo0 . ok :
 ...
 'tagline' : IIiiii1IiIiII . get ( 'tagline' )
   ...
   try :
    oO00OOooOoO0o = load_json_file ( xbmcvfs . translatePath ( 'special://home/addons/plugin.video.eduteamo/resources/iso3166.json' ) )
 ...
 'profile_path' : ''
    ...
    if o0 [ O00 ] . get ( 'profile_path' ) :
     ...
     OOOooOOoo [ 'profile_path' ] = 'special://home/addons/plugin.video.eduteamo/resources/media/mujer.png'
    elif o0 [ O00 ] . get ( 'gender' ) == 2 :
     OOOooOOoo [ 'profile_path' ] = 'special://home/addons/plugin.video.eduteamo/resources/media/hombre.png'
    else :
     OOOooOOoo [ 'profile_path' ] = 'special://home/addons/plugin.video.eduteamo/resources/media/nodefinido.png'
   ...
   if type == 'tv' :
    ...
    if OOO0ooOO :
     OO0oOoOOOoO0 = load_json_file ( xbmcvfs . translatePath ( 'special://home/addons/plugin.video.eduteamo/resources/status.json' ) )
